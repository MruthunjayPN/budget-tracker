...
import { Currencies, Currency } from "@/lib/curriencies"
...
export function CurrencyComboBox() {
  ...
  console.log("USER Settings : " , userSettings);  //just to check the response 
  ...
  //anything other than create , are consider are mutate fns in react query/tanstack
